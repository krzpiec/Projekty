...
#   endif
    ...
    bool isEdge = dot(normalize(viewDir), normalize(normal)) < _NormalOutlineCutoff;
    ...
    if (isEdge) {
        ...
        color = _OutlineColor;
         ...
         half colorMag = length(color);
         half cellRatio = _CellCount * colorMag;
         cellRatio = ceil(cellRatio);
         cellRatio /= (half)_CellCount;
